...
from . import speculative_generate_batch_v2, speculative_generate_batch_v3, speculative_generate_batch_v4
...
target_model = AutoModelForCausalLM.from_pretrained(target, device_map=device, dtype=torch.bfloat16, attn_implementation="sdpa",)
...
for draft_name, draft in config['models']['drafts'].items():
    ...
    draft_model  = AutoModelForCausalLM.from_pretrained(draft, device_map=device, dtype=torch.bfloat16, attn_implementation="sdpa",)
